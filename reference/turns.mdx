...
sidebarTitle: "Turns"
description: "Complete reference for all TurnsController and TurnsPublicController endpoints — appointment CRUD, DataTables integration, export, and public walk-in booking."
---
...
| `POST` | `/Turns/ExportPdf` | Ingreso, Medico | Downloads current view as `.pdf` |
