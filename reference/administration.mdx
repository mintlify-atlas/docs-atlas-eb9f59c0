...
description: "Reference for AdministrationController, RoleController, MedicsController, TimeTurnController, and FirebaseController endpoints. Most require the Admin role."
---
...
| `GET` | `/Administration/EditUsersInRole/{roleId}` | Admin | Role membership form |
...
### GET /Administration/EditUsersInRole/{roleId}
...
<ParamField path="roleId" type="string" required>
  The `IdentityRole.Id` whose membership to edit.
</ParamField>
